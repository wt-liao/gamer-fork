...
#  ifndef SUPPORT_GRACKLE
   Aux_Error( ERROR_INFO, "GRACKLE must be enabled !!\n" );
#  ifndef GRACKLE_H2_SOBOLEV
   Aux_Error( ERROR_INFO, "GRACKLE_H2_SOBOLEV must be enabled !!\n" );
...
// Return      :  None
//-------------------------------------------------------------------------------------------------------
void Init_TestProb_Hydro_PopIII_Sobolev()
{
